    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Als Fullstack-Webentwickler arbeite ich täglich an realen Projekten
            – von der Planung über die Umsetzung bis hin zur Wartung. In meiner
          ...
          <p
            class="py-3 text-left text-xs text-gray-200 sm:text-sm md:text-base lg:text-xl"
          >
            In meiner Zeit als Entwickler habe ich gemerkt, wie gut der Beruf zu
            mir passt. Er verbindet das, was mich sowieso antreibt — Neugier,
            logisches Denken und technisches Verständnis. Komplexe Probleme zu
            lösen und dabei ständig dazuzulernen ist im Alltag genau das, was
            mir an dem Job am meisten Spaß macht.
          </p>
        </div>
      </div>
    </div>
